...
/* ESERCIZIO 2
 ...
 come parametro e ritorna true se tale parametro è incluso tra 
 20 e 100 (incluso) o se è esattamente uguale a 400.
*/
...
/* ESERCIZIO 3
 Scrivi una funzione chiamata "reverseString", che accetta una 
 stringa come parametro e la ritorna invertita (es.: EPICODE => EDOCIPE).
*/
...
/* ESERCIZIO 4
 Scrivi una funzione chiamata "upperFirst", che accetta una stringa
  come parametro e la ritorna rendendo maiuscola ogni lettera iniziale
   di ogni parola.
*/
...
/* ESERCIZIO 5
 ...
 un numero chiamato n e ritorna un array contenente n numeri random contenuti 
 tra 0 e 10.
*/
...
/* ESERCIZIO 2
 Scrivi una funzione chiamata "crazyDiff" che calcola la differenza 
 assoluta tra un numero fornito e 19.
 Se il valore calcolato è più grande di 19, la funzione deve tornare tale 
...
/* ESERCIZIO 3
 Scrivi una funzione chiamata "codify" che accetta una 
 stringa come parametro.
 La funzione deve aggiungere la parola "code" all'inizio della 
 stringa fornita e ritornare il risultato, ma se la stringa fornita
...
/* ESERCIZIO 4
 Scrivi una funzione chiamata "check3and7" la quale accetta un
  numero intero positivo come parametro.
 La funzione deve controllare che tale parametro sia un multiplo
...
/* ESERCIZIO 5
 Scrivi una funzione chiamata "cutString", che accetta una stringa
  come parametro e la ritorna senza il primo e l'ultimo carattere.
*/
...
function upperFirst(stringa) {
  let strong = stringa.split('')
  for (let i = 0; i < strong.length; i++) {
      strong[i]= strong[i].charAt(0).toUpperCase() + strong[i].slice(1).toLowerCase();
      return  strong.join('');
  }
} console.log(upperFirst ("papa come va "))
